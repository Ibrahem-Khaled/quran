          ...
          <FlatList
            ...
            renderItem={({ item, index }) => (
              <View style={styles.container1}>
                <TouchableOpacity onPress={() => { navigation.navigate("Quran", { identifier: item.identifier, name: item.name, type: "audio" }) }} style={{ flexDirection: "row", justifyContent: "space-around" }}>
